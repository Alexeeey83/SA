...
<ol>
  ...
  <li>Задача №2.</li>
  Пересчитеть план найма преподавателей с учетом измененных планов маркетинга.
</ol>

<p>Как решал: <p>
Разработал калькулятор маржинальности по имеющимся данным.</li>
Добавил в список параметров калькулятора показатель "Поправочный коэф-т на привлечение"</li>
